...
export const meta = {
  ...
  lastEdited: '2019-11-15T18:40:05.000Z'
}
...
Open HTTP stream of realtime logs for a Serverless Function by it's name
...
Get failed request logs of a Serverless Function by it's name
